...
namespace Optoel
{
    public class Optoel
    {
        ...
        public class Ble
        {
            ...
            #region Ble Connect
            List<BleSlave> ListBleSlave = new List<BleSlave>();
            ...
            void ATTClientProcedureCompletedEvent(object sender, ProcedureCompletedEventArgs e)
            {
                ...
                else
                {
                    ...
                    {
                        if (ListBleSlave.Exists(x => x.MacAddress == device.MAC_Address) == true)
                        {
                            int index = ListBleSlave.FindIndex(x => x.MacAddress == device.MAC_Address);
                            ListBleSlave[index].slave = slave;
                            bleSlave = ListBleSlave[index];
                        }
                        else
                        {
            ...
            public delegate void EnableEventHandler(BleSlave sender, BleSlave.EnableResultArgs e);
            ...
            public delegate void BwEventHandler(BleSlave sender, BleSlave.BwResultArgs e);
            ...
            public delegate void RangeEventHandler(BleSlave sender, BleSlave.RangeResultArgs e);
            ...
            public delegate void ReadEnableEventHandler(BleSlave sender, BleSlave.ReadEnableResultArgs e);
            ...
            public event EnableEventHandler EnableResult;
            ...
            public event BwEventHandler BwResult;
            ...
            public event RangeEventHandler RangeResult;
            ...
            public event ReadEnableEventHandler ReadEnableResult;
                    ...
                    if (data[0] == 0x00)   // Response: 0x00
                    {
                        ...
                        else if (data[1] == 0x01)  // Enable/Disable
                        {
                            if (data[2] == 0x01)   // Accel
                            {
                                ...
                                if (ble.EnableResult != null)
                                    ble.EnableResult(this, new EnableResultArgs(Sensor.Accel, AccelEnableSucces, enable));

                                //if (ble.AccelEnableResult != null)
                                //    ble.AccelEnableResult(this, new EnableResultArgs(Sensor.Accel, AccelEnableSucces, enable));
                            ...
                            else if (data[2] == 0x02)  // Gyro
                            {
                                ...
                                if (ble.EnableResult != null)
                                    ble.EnableResult(this, new EnableResultArgs(Sensor.Gyro, GyroEnableSuccess, enable));
                            ...
                            else if (data[2] == 0x04)  // Magno
                            {
                                ...
                                if (ble.EnableResult != null)
                                    ble.EnableResult(this, new EnableResultArgs(Sensor.Magno, MagnoEnableSucccess, enable));
                        ...
                        else if (data[1] == 0x02)  // Bw
                        {
                            if (data[2] == 0x01)   // Accel
                            {
                                ...
                                if (ble.BwResult != null)
                                    ble.BwResult(this, new BwResultArgs(Sensor.Accel, AccelBwSuccess, accelbw));
                            ...
                            else if (data[2] == 0x02)  // Gyro
                            {
                                ...
                                if (ble.BwResult != null)
                                    ble.BwResult(this, new BwResultArgs(Sensor.Gyro, GyroBwSuccess, gyroBw));
                            ...
                            else if (data[2] == 0x04)  // Magno
                            {
                                ...
                                if (ble.BwResult != null)
                                    ble.BwResult(this, new BwResultArgs(Sensor.Magno, MagnoBwSuccess, magnoBw));
                        ...
                        else if (data[1] == 0x03)  // Range
                        {
                            if (data[2] == 0x01)   // Accel
                            {
                                ...
                                if (ble.RangeResult != null)
                                    ble.RangeResult(this, new RangeResultArgs(Sensor.Accel, AccelRangeSuccess, accelRange));
                            ...
                            else if (data[2] == 0x02)  // Gyro
                            {
                                ...
                                if (ble.RangeResult != null)
                                    ble.RangeResult(this, new RangeResultArgs(Sensor.Gyro, GyroRangeSuccess, gyroRange));
                        ...
                        else if (data[1] == 0x04)  // Read Enable
                        {
                            if (data[2] == 0x01)   // Accel
                            {
                                ...
                                if (ble.ReadEnableResult != null)
                                    ble.ReadEnableResult(this, new ReadEnableResultArgs(Sensor.Accel, AccelReadEnableSuccess, enable));
                            ...
                            else if (data[2] == 0x02)  // Gyro
                            {
                                ...
                                if (ble.ReadEnableResult != null)
                                    ble.ReadEnableResult(this, new ReadEnableResultArgs(Sensor.Gyro, GyroReadEnableSuccess, enable));
                            ...
                            else if (data[2] == 0x04)  // Magno
                            {
                                ...
                                if (ble.ReadEnableResult != null)
                                    ble.ReadEnableResult(this, new ReadEnableResultArgs(Sensor.Magno, MagnoReadEnableSuccess, enable));
