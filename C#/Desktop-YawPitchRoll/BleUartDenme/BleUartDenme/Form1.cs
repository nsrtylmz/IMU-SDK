...
namespace BleUartDenme
{
    public partial class Form1 : Form
    {
        ...
        void Grafikhazirla()
        {
            ...
            //Ble
            //accelPane = accelZedGraph.GraphPane;
            ...
            //accelCurveBle2 = accelPaneBle2.AddCurve(null, accelYBle2, Color.Blue, SymbolType.None);
            //accelCurveBle2 = accelPaneBle2.AddCurve(null, accelZBle2, Color.Green, SymbolType.None);
            gyroCurve = gyroPane.AddCurve(null, Yaw, Color.Red, SymbolType.None);
            gyroCurve = gyroPane.AddCurve(null, Pitch, Color.Blue, SymbolType.None);
            gyroCurve = gyroPane.AddCurve(null, Roll, Color.Green, SymbolType.None);
            //magnoCurveBle2 = magnoPaneBle2.AddCurve(null, magnoXBle2, Color.Red, SymbolType.None);
            //magnoCurveBle2 = magnoPaneBle2.AddCurve(null, magnoYBle2, Color.Blue, SymbolType.None);
            //magnoCurveBle2 = magnoPaneBle2.AddCurve(null, magnoZBle2, Color.Green, SymbolType.None);
        }
        ...
        private void BleConnectResultEvent(Optoel.Ble.BleSlave bleSlave)
        {
            ...
            if(ComboBox == 1)
            {
                ...
                //bleSlave1.SlaveAccelEnableResult += new Optoel.Optoel.Ble.BleSlave.AccelEnableEventHandler(SlaveAccelEnableResultEventBle1);
                //bleSlave1.SlaveGyroEnableResult += new Optoel.Optoel.Ble.BleSlave.GyroEnableEventHandler(SlaveGyroEnableResultEventBle1);
                //bleSlave1.SlaveMagnoEnableResult += new Optoel.Optoel.Ble.BleSlave.MagnoEnableEventHandler(SlaveMagnoEnableResultEventBle1);

                //bleSlave1.SlaveAccelBwResult += new Optoel.Optoel.Ble.BleSlave.AccelBwEventHandler(SlaveAccelBwResultEventBle1);
                //bleSlave1.SlaveGyroBwResult += new Optoel.Optoel.Ble.BleSlave.GyroBwEventHandler(SlaveGyroBwResultEventBle1);
                //bleSlave1.SlaveMagnoBwResult += new Optoel.Optoel.Ble.BleSlave.MagnoBwEventHandler(SlaveMagnoBwResultEventBle1);

                //bleSlave1.SlaveAccelRangeResult += new Optoel.Optoel.Ble.BleSlave.AccelRangeEventHandler(SlaveAccelRangeResultEventBle1);
                //bleSlave1.SlaveGyroRangeResult += new Optoel.Optoel.Ble.BleSlave.GyroRangeEventHandler(SlaveGyroRangeResultEventBle1);

                //bleSlave1.SlaveAccelReadEnableResult += new Optoel.Optoel.Ble.BleSlave.AccelReadEnableEventHandler(SlaveAccelReadEnableResultEventBle1);
                //bleSlave1.SlaveGyroReadEnableResult += new Optoel.Optoel.Ble.BleSlave.GyroReadEnableEventHandler(SlaveGyroReadEnableResultEventBle1);
                //bleSlave1.SlaveMagnoReadEnableResult += new Optoel.Optoel.Ble.BleSlave.MagnoReadEnableEventHandler(SlaveMagnoReadEnableResultEventBle1);

                //bleSlave1.AccelData += new Optoel.Optoel.Ble.BleSlave.AccelDataEventHandler(AccelDataEventBle1);
                //bleSlave1.GyroData += new Optoel.Optoel.Ble.BleSlave.GyroDataEventHandler(GyroDataEventBle1);
                //bleSlave1.MagnoData += new Optoel.Optoel.Ble.BleSlave.MagnoDataEventHandler(MagnoDataEventBle1);
            ...
            else if( ComboBox == 2)
            {
                ...
                //bleSlave2.SlaveAccelEnableResult += new Optoel.Optoel.Ble.BleSlave.AccelEnableEventHandler(SlaveAccelEnableResultEventBle2);
                //bleSlave2.SlaveGyroEnableResult += new Optoel.Optoel.Ble.BleSlave.GyroEnableEventHandler(SlaveGyroEnableResultEventBle2);
                //bleSlave2.SlaveMagnoEnableResult += new Optoel.Optoel.Ble.BleSlave.MagnoEnableEventHandler(SlaveMagnoEnableResultEventBle2);

                //bleSlave2.SlaveAccelBwResult += new Optoel.Optoel.Ble.BleSlave.AccelBwEventHandler(SlaveAccelBwResultEventBle2);
                //bleSlave2.SlaveGyroBwResult += new Optoel.Optoel.Ble.BleSlave.GyroBwEventHandler(SlaveGyroBwResultEventBle2);
                //bleSlave2.SlaveMagnoBwResult += new Optoel.Optoel.Ble.BleSlave.MagnoBwEventHandler(SlaveMagnoBwResultEventBle2);

                //bleSlave2.SlaveAccelRangeResult += new Optoel.Optoel.Ble.BleSlave.AccelRangeEventHandler(SlaveAccelRangeResultEventBle2);
                //bleSlave2.SlaveGyroRangeResult += new Optoel.Optoel.Ble.BleSlave.GyroRangeEventHandler(SlaveGyroRangeResultEventBle2);

                //bleSlave2.SlaveAccelReadEnableResult += new Optoel.Optoel.Ble.BleSlave.AccelReadEnableEventHandler(SlaveAccelReadEnableResultEventBle2);
                //bleSlave2.SlaveGyroReadEnableResult += new Optoel.Optoel.Ble.BleSlave.GyroReadEnableEventHandler(SlaveGyroReadEnableResultEventBle2);
                //bleSlave2.SlaveMagnoReadEnableResult += new Optoel.Optoel.Ble.BleSlave.MagnoReadEnableEventHandler(SlaveMagnoReadEnableResultEventBle2);

                //bleSlave2.AccelData += new Optoel.Optoel.Ble.BleSlave.AccelDataEventHandler(AccelDataEventBle2);
                //bleSlave2.GyroData += new Optoel.Optoel.Ble.BleSlave.GyroDataEventHandler(GyroDataEventBle2);
                //bleSlave2.MagnoData += new Optoel.Optoel.Ble.BleSlave.MagnoDataEventHandler(MagnoDataEventBle2);
